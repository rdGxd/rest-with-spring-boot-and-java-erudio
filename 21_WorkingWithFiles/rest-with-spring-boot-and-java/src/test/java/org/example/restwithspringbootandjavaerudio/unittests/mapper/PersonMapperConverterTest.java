...
public class PersonMapperConverterTest {
    ...
    public void parseEntityToVOTest() {
        PersonVO output = MapperPerson.parseObject(inputObject.mockEntity(), PersonVO.class);
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = MapperPerson.parseListObjects(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parseVOToEntityTest() {
        Person output = MapperPerson.parseObject(inputObject.mockVO(), Person.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = MapperPerson.parseListObjects(inputObject.mockVOList(), Person.class);
