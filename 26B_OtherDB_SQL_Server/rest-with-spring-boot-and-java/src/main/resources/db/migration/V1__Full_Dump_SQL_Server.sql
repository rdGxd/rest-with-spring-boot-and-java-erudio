...
INSERT INTO dbo.person ([address], [first_name], [gender], [last_name], [enabled])
VALUES ('Uberlândia - Minas Gerais - Brasil', 'Leandro', 'Male', 'Costa', 'TRUE'),
...
INSERT INTO dbo.users ([user_name], [full_name], [password], [account_non_expired], [account_non_locked],
                       [credentials_non_expired], [enabled])
VALUES ('leandro', 'Leandro Costa', '$2a$16$9qr2tv0HmXbHBsx.TZFjfux742wCZM32a8Wi6iBqwIqaizlHPuxHS', 'TRUE', 'TRUE',
        'TRUE', 'TRUE'),
       ('flavio', 'Flavio Costa', '$2a$16$h4yDQCYTy62R6xrtFDWONeMH3Lim4WQuU/aj8hxW.dJJoeyvtEkhK', 'TRUE', 'TRUE',
        'TRUE', 'TRUE')
GO
...
INSERT INTO dbo.user_permission ([id_user], [id_permission])
VALUES (1, 1),
       (2, 1),
       (1, 2);